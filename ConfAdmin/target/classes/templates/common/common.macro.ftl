...
<#--				<li class="header">导航</li>-->
				<li class="nav-click <#if pageName == "conf">active</#if>" ><a href="${request.contextPath}/conf"><span>配置管理</span></a></li>
				<#if Request["XXL_CONF_LOGIN_IDENTITY"].permission == 1>
                    <li class="nav-click <#if pageName == "user">active</#if>" ><a href="${request.contextPath}/user"><span>用户管理</span></a></li>
					<li class="nav-click <#if pageName == "project">active</#if>" ><a href="${request.contextPath}/project"><span>项目管理</span></a></li>
					<li class="nav-click <#if pageName == "env">active</#if>" ><a href="${request.contextPath}/env"><span>环境管理</span></a></li>
				</#if>
